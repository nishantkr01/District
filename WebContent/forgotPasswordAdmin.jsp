		...
		<div class="wrapper">
			<div class="form-inner-cont">
				...
				<form action="ForgotPassword" method="post" class="signin-form">
					...
					<input type="hidden" name="tt" value="adminPassword">
					...
					<div class="form-input">
						<span class="fa fa-key" aria-hidden="true"></span> <input type="text" name="address" placeholder="Address"
							...
							<a href="adminLogin.jsp" class="btn theme-button">Login Now</a>
						</div>
				...
				<p class="signup"> <a href="userLogin.jsp" class="signuplink">Login Now!</a></p>
			</div>
